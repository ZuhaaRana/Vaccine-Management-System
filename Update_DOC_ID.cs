...
{
    public partial class Update_DOC_ID : Form
    {
        public Update_DOC_ID()
        {
            InitializeComponent();
        }
        ...
        {
            {
                ...
                {
                    string q = "Update PATIENT SET (DOC_ID) =  ('" + textBox2.Text.ToString() + "') WHERE (Patient_ID) = ('" + textBox1.Text.ToString() + "')";
